...
export const translations: Record<"en" | "ml", TranslationSet> = {
  en: {
    ...
    introText1: "At Care Village, we believe that premium physical rehab should not be a luxury. Operating under a non-profit trust, our unique model ensures that clinical excellence goes hand-in-hand with social impact. Fees collected from those who can afford it are directed to fund completely free treatment for families under economic strain.",
    ...
    servicesSubtitle: "Professional therapy programs designed to restore function, strength, and mobility at highly subsidized, family-friendly rates.",
    ...
    statTreatments: "Subsidized & Free Treatments",
    ...
    aboutPhilosophyDesc: "We practice slow, focused, patient-centered medicine. We spend time listening, analyzing physical roots, and designing home-care support, rather than hurrying through short machine sessions.",
    aboutWhyCharityTitle: "Why Community Healthcare Matters",
    aboutWhyCharityDesc: "High rehabilitation costs often lead patients to abandon recovery early, causing long-term physical limitations. By keeping rates affordable and operating outreach, we protect vulnerable families.",
    ...
    outreachTitle: "NGO & Community Outreach Initiatives",
    outreachSubtitle: "Care Charitable Trust goes beyond the clinic doors to offer hope and healing in underserved areas.",
    ...
    outreachFreeDesc: "Patients with low-income certificates or BPL classifications receive completely free access to all clinical therapy units, including custom orthotic aids and support devices.",
    ...
    outreachIntegrityDesc: "All donations and clinic collections are transparently audited. Every single rupee of surplus is re-invested into updating therapeutic equipment and running free mobile checkup vans.",
    ...
    contactSubtitle: "Have questions about our subsidies or treatments? Reach out via phone, email, WhatsApp, or drop by our welcoming Edappal clinic.",
  ...
  ml: {
    ...
    introText1: "കെയർ വില്ലേജിൽ, ഉയർന്ന നിലവാരമുള്ള ഫിസിയോതെറാപ്പി ചികിത്സകൾ ആർക്കും അപ്രാപ്യമാകരുത് എന്ന് ഞങ്ങൾ കരുതുന്നു. ഒരു നോൺ-പ്രോഫിറ്റ് ട്രസ്റ്റിന് കീഴിൽ പ്രവർത്തിക്കുന്ന ഞങ്ങളുടെ സവിശേഷമായ മാതൃക, ചികിത്സാ മികവ് കമ്മ്യൂണിറ്റി സേവനങ്ങളുമായി സംയോജിപ്പിക്കുന്നു. സാമ്പത്തികശേഷിയുള്ളവരിൽ നിന്ന് ഈടാക്കുന്ന ഫീസ്, അർഹരായ നിർധന കുടുംബങ്ങളിലെ രോഗികൾക്ക് തികച്ചും സൗജന്യമായി ചികിത്സ നൽകാൻ വിനിയോഗിക്കുന്നു.",
    ...
    servicesSubtitle: "വളരെ കുറഞ്ഞ നിരക്കിലും അർഹരായവർക്ക് പൂർണ്ണമായും സൗജന്യമായും വേദനരഹിതമായ ചലനശേഷി നൽകുന്നതിനായി തയ്യാറാക്കിയ ഫിസിയോതെറാപ്പി സേവനങ്ങൾ.",
    ...
    statTreatments: "സൗജന്യ & സബ്‌സിഡി ചികിത്സകൾ",
    ...
    aboutWhyCharityDesc: "ഉയർന്ന പുനരധിവാസ ചികിത്സാ ചിലവുകൾ പല രോഗികളെയും ചികിത്സ പൂർത്തിയാക്കുന്നതിൽ നിന്ന് പിന്തിരിപ്പിക്കുന്നു. ഇത് തടയാൻ ഞങ്ങൾ ചികിത്സ കുറഞ്ഞ നിരക്കിൽ ലഭ്യമാക്കുന്നു.",
    ...
    outreachTitle: "കമ്മ്യൂണിറ്റി ഔട്ട്രീച്ച് സംരംഭങ്ങൾ",
    outreachSubtitle: "ഗ്രാമീണ മേഖലകളിലെ ബുദ്ധിമുട്ടുന്ന രോഗികളിലേക്ക് പ്രത്യാശയും ചികിത്സയുമായി കെയർ ചാരിറ്റബിൾ ട്രസ്റ്റ് എത്തുന്നു.",
    ...
    outreachFreeDesc: "നിർധനരും അർഹരുമായ രോഗികൾക്ക് എല്ലാത്തരം ഫിസിയോതെറാപ്പി ചികിത്സകളും പൂർണ്ണമായും സൗജന്യമായി നൽകുന്നു.",
    ...
    outreachIntegrityDesc: "ട്രസ്റ്റിലേക്ക് ലഭിക്കുന്ന ഓരോ സംഭാവനയും പൂർണ്ണമായും സുതാര്യമായി ഓഡിറ്റ് ചെയ്യുകയും ചികിത്സാ നവീകരണത്തിനായി വിനിയോഗിക്കുകയും ചെയ്യുന്നു.",
    ...
    contactSubtitle: "ചികിത്സയെക്കുറിച്ചോ സബ്‌സിഡികളെക്കുറിച്ചോ സംശയങ്ങളുണ്ടോ? ഫോണിലൂടെയോ വാട്സാപ്പിലൂടെയോ എടപ്പാളിലെ ഞങ്ങളുടെ ക്ലിനിക് സന്ദർശിച്ചോ ചോദിക്കാവുന്നതാണ്.",
